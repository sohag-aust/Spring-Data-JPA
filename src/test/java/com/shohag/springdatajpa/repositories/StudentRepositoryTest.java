...
//    }
    ...
    @Test
    public void findStudentByEmailIdByJPQLQuery() {
        Student student = studentRepository.getStudentByEmailId("sohag@gmail.com");
        System.out.println(student);
    }

    @Test
    public void findStudentFirstNameByEmailIdByJPQLQuery() {
    ...
    @Test
    public void findStudentByEmailAddressUsingNativeQueryNamedParams() {
        Student student = studentRepository.getStudentByEmailIdUsingNativeQueryNamedParams("sohag@gmail.com");
        System.out.println(student);
    }

    @Test
    public void updateStudentFirstNameByEmailId() {
        studentRepository.updateStudentNameByEmailId("Shohag", "sohag@gmail.com");
    }
}